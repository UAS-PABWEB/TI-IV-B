...
header("Content-Disposition: attachment; filename=Data-rincianbiaya.xls");//ganti nama sesuai keperluan
header("Pragma: no-cache");
header("Expires: 0");
//disini script laporan anda
?>
<?php include"koneksi.php";
$data=mysql_query("SELECT *from rincianbiaya ");
...
<div>
  <h2 align="center" style="color:#0000FF;">DATA RINCIAN BIAYA<br/>
  POLIKELINIK YADI</h2>
  <div style="padding-top:10px;"></div>
</div>
<form method="post" action="deleteall_rincianbiaya.php">
<?php
    ...
    <tr>
      <td><table width="100%" cellspacing="1" cellpadding="3" ><tr bgcolor="#009b4c" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" ><td width="9%"><table width="100%" cellspacing="1" cellpadding="3" >
        <tr bgcolor="#8fb041" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" >
		  ...
		  <td width="8%" height="30" bgcolor="#009b4c">ID RINCIAN BIAYA </td>
          <td width="8%" height="30" bgcolor="#009b4c">ID JENIS BIAYA </td>
          <td width="11%" bgcolor="#009b4c">NO PENDAFTARAN</td>
        </tr>
        <?php
	if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
{
	$search = $_POST['search'];
	$sql1 = mysql_query("SELECT * FROM rincianbiaya LIKE '%$search%'") or die(mysql_error());
	}
	else{
	$sql1 = mysql_query("SELECT * FROM rincianbiaya  order by idjenisbiaya asc LIMIT $mulai,$jum_hal");
	}
  ...
  <tr><td align="center" bgcolor="#ffffff"><?php echo $no=$no+1;?></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['idrincianbiaya']?></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['idjenisbiaya']?></td>
    <td align="center" bgcolor="#ffffff"><a href=""><?php echo $tampil['nopendaftaran']?></a></td>
    </tr>
  <?php
  }
}
