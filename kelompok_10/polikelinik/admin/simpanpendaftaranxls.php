...
header("Content-Disposition: attachment; filename=Data-pendaftaran.xls");//ganti nama sesuai keperluan
...
<div>
  <h2 align="center" style="color:#0000FF;">DATA PENDAFTARAN<br/>
  POLIKELINIK YADI</h2>
  <div style="padding-top:10px;"></div>
</div>
<form method="post" action="deleteall_pendaftaran.php">
<?php
    ...
    <tr>
      <td><table width="100%" cellspacing="1" cellpadding="3" ><tr bgcolor="#009b4c" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" ><td width="9%"><table width="100%" cellspacing="1" cellpadding="3" >
        <tr bgcolor="#8fb041" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" >
          ...
          <td width="8%" height="30" bgcolor="#009b4c">NO PENDAFTARAN</td>
		  <td width="11%" bgcolor="#009b4c">TANGGAL PENDAFTARAN</td>
          <td width="11%" bgcolor="#009b4c">NO URUT</td>
          <td width="12%" bgcolor="#009b4c">NIP</td>
          <td width="9%" bgcolor="#009b4c">NO PASIEN</td>
          <td width="10%" bgcolor="#009b4c">KODE JADWAL</td>
          </tr>
        <?php
	if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
{
	$search = $_POST['search'];
	$sql1 = mysql_query("SELECT * FROM pendaftaran LIKE '%$search%'") or die(mysql_error());
	}
	else{
  ...
  <tr><td align="center" bgcolor="#ffffff"><?php echo $no=$no+1;?></td>
    ...
    <td align="center" bgcolor="#ffffff"><a href=""><?php echo $tampil['tglpendaftaran']?></a></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['nourut'];?></td>
