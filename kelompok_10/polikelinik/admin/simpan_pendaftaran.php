...
$NI=mysql_query("SELECT NI FROM pegawai WHERE NI='$pegawai'");
$NI=mysql_fetch_array($NI);
...
if (!empty($_FILES["photo"]["tmp_name"]))
  ...
  { die("Gambar gagal dikirim"); }
		...
		mysql_query("insert into pendaftaran(nopendaftaran, tglpendaftaran, nourut, NI, nopasien, kodejadwal)values('$nopendaftaran','$tglpendaftaran','$nourut','$NI[NI]','$nopasien[nopasien]','$kodejadwal[kodejadwal]')");
