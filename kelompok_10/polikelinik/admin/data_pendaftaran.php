...
<div>
  ...
  <tr>
    ...
    <td width="40%"><a href="?page=data_pendaftaran" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="?page=input_pendaftaran">[+Tambah]</a>&nbsp;&nbsp;<a href="simpanpendaftaranxls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
	...
	if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
{
	...
	$sql1 = mysql_query("SELECT * FROM pendaftaran,pegawai where pegawai.NIP=pendaftaran.NI  order by nopendaftaran asc LIMIT $mulai,$jum_hal");
	}
	...
	?>
      <tr bgcolor="#CCCCCC"><td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $tampil['nopendaftaran'];?>"/></td>
       <td><div align="center"><?php echo $no=$no+1;?></td>
		  ...
		  <td align="center"><?php echo $tampil['NI'];?></td>
		  <td align="center"><?php echo $tampil['namapeg'];?></td>
		  <td align="center"><?php echo $tampil['nopasien'];?></td>
		  <td align="center"><?php echo $tampil['kodejadwal'];?></td>
          <td width="6%"><div align="center"><a href="?page=edit_pendaftaran&nopendaftaran=<?php echo $tampil['nopendaftaran'];?>">Edit</a></div></td>
          <td width="6%"><div align="center"><a href="?page=delete_pendaftaran&nopendaftaran=<?php echo $tampil['nopendaftaran'];?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a></div></td>
          </tr>
        <?php
  }
}
