...
<div>
  ...
  <tr>
    ...
    <td width="40%"><a href="?page=data_polikelinik" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="?page=input_polikelinik">[+Tambah]</a>&nbsp;&nbsp;<a href="simpanpolikelinikxls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
	...
	?>
      <tr bgcolor="#CCCCCC"><td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $tampil['kodepoll'];?>"/></td>
       <td><div align="center"><?php echo $no=$no+1;?></td>
          ...
          <td width="6%"><div align="center"><a href="?page=edit_polikelinik&kodepoll=<?php echo $tampil['kodepoll'];?>">Edit</a></div></td>
          <td width="6%"><div align="center"><a href="?page=delete_polikelinik&kodepoll=<?php echo $tampil['kodepoll'];?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a></div></td>
          </tr>
        <?php
  }
}
