...
<div>
  ...
  <tr>
    ...
    <td width="40%"><a href="?page=data_pegawai" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="?page=input_pegawai">[+Tambah]</a>&nbsp;&nbsp;<a href="simpanpegawaixls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
	...
	?>
      <tr bgcolor="#CCCCCC"><td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $tampilkan['NIP'];?>"/></td>
       <td><div align="center"><?php echo $no=$no+1;?></td>
          ...
          <td align="center"><a href="?page=detail_pegawai&NIP=<?php echo $tampilkan['NIP'];?>"><?php echo $tampilkan['namapeg']?></a></td>
		  <td align="center"><?php echo $tampilkan['almpeg'];?></td>
          <td align="center"><?php echo $tampilkan['telppeg'];?></td>
          <td width="6%"><div align="center"><a href="?page=edit_pegawai&NIP=<?php echo $tampilkan['NIP'];?>">Edit</a></div></td>
          <td width="6%"><div align="center"><a href="?page=delete_pegawai&NIP=<?php echo $tampilkan['NIP'];?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a></div></td>
          </tr>
        <?php
  }
}
