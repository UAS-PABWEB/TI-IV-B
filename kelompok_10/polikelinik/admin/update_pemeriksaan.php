...
else
{
	...
	$masukan=mysql_query("UPDATE pemeriksaan SET nopemeriksaan='$nopemeriksaan',keluhan='$keluhan', diagnosa='$diagnosa',  perawatan='$perawatan', tindakan='$tindakan', beratbadan='$beratbadan', tensidiastolik='$tensidiastolik', tensisistolik='$tensisistolik', nopendaftaran='$nopendaftaran[nopendaftaran]'WHERE nopemeriksaan='$nopemeriksaan'");
	if($masukan){
