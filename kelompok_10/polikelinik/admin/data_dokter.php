...
<div>
  ...
  <tr>
    ...
    <td width="40%"><a href="?page=data_dokter" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="?page=input_dokter">[+Tambah]</a>&nbsp;&nbsp;<a href="simpandokterxls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
      ...
      <td height="64"><table width="100%" height="74" cellpadding="2" cellspacing="1">
       ...
       <td width="4%" height="42">&nbsp;</td>
         <td width="4%">NO</td>
		  ...
		  <td width="20%">TELEPON DOKTER</td>
          <td width="25%">KODE POLIKLINIK</td>
      ...
      <tr bgcolor="#CCCCCC"><td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $tampil['kodedokter'];?>"/></td>
       <td><div align="center"><?php echo $no=$no+1;?></td>
        ...
        <td><a href="?page=detail_dokter&kodedokter=<?php echo $tampil['kodedokter'];?>"><?php echo $tampil['nmdokter']?></a></td>
		  ...
		  <td align="center"><?php echo $tampil['telpdokter'];?></td>
		     <td align="center"><?php echo $tampil['kodepoll'];?></td>
          <td width="6%"><div align="center"><a href="?page=edit_dokter&kodedokter=<?php echo $tampil['kodedokter'];?>">Edit</a></div></td>
          <td width="6%"><div align="center"><a href="?page=delete_dokter&kodedokter=<?php echo $tampil['kodedokter'];?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a></div></td>
          </tr>
        <?php
  }
}
