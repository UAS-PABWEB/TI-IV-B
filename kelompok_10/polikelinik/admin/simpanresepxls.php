...
header("Content-Disposition: attachment; filename=Data-resep.xls");//ganti nama sesuai keperluan
header("Pragma: no-cache");
header("Expires: 0");
//disini script laporan anda
?>
<?php include"koneksi.php";
$data=mysql_query("SELECT *from resep ");
...
<div>
  <h2 align="center" style="color:#0000FF;">DATA RESEP<br/>
  POLIKELINIK YADI</h2>
  <div style="padding-top:10px;"></div>
</div>
<form method="post" action="deleteall_resep.php">
<?php
    ...
    <tr>
      <td><table width="100%" cellspacing="1" cellpadding="3" ><tr bgcolor="#009b4c" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" ><td width="9%"><table width="100%" cellspacing="1" cellpadding="3" >
        <tr bgcolor="#8fb041" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" >
          ...
          <td width="8%" height="30" bgcolor="#009b4c">NO RESEP</td>
          <td width="11%" bgcolor="#009b4c">DOSIS</td>
          <td width="12%" bgcolor="#009b4c">JUMLAH</td>
          <td width="9%" bgcolor="#009b4c">KODE OBAT</td>
          <td width="10%" bgcolor="#009b4c">NO PEMERIKSAAN</td>
          </tr>
        <?php
	if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
{
	$search = $_POST['search'];
	$sql1 = mysql_query("SELECT * FROM resep LIKE '%$search%'") or die(mysql_error());
	}
	else{
  ...
  <tr><td align="center" bgcolor="#ffffff"><?php echo $no=$no+1;?></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['noresep']?></td>
    <td align="center" bgcolor="#ffffff"><a href=""><?php echo $tampil['dosis']?></a></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['jumlah'];?></td>
