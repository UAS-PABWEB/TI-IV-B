...
<div style="width:500px; margin:auto;">
	<table width="100%" cellspacing="0" cellpadding="3">
		...
		<tr>
			<td colspan="3"><a href="?page=edit_resep&noresep=<?php echo $tampilresep['noresep'];?>" title="sunting">[SUNTING]</a>&nbsp;&nbsp;<a href="javascript:history.back()" title="data res">[KEMBALI]</a>&nbsp;&nbsp;</td>
		</tr>
	</table>
</div>
</body>
