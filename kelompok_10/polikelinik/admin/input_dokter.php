...
$ambilkan = mysql_query("SELECT MAX(kodedokter) AS kodedokter FROM dokter");
...
<table width="130%" height="400" cellpadding="3" cellspacing="0">
      <tr>
      ...
      <tr>
        <td width="100" style="padding-left:10px;">KODE DOKTER</td>
        <td width="20" >:</td>
      ...
      <tr>
        ...
        <td><input name="almdokter" type="text" size="50" placeholder="Masukan Alamat Dokter" required="required"/></td>
	  	...
	  	<tr>
        <td style="padding-left:10px;">TELEPON DOKTER</td>
        <td>:</td>
