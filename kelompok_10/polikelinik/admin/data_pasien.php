...
<div>
  ...
  <tr>
    ...
    <td width="40%"><a href="?page=data_pasien" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="?page=input_pasien">[+Tambah]</a>&nbsp;&nbsp;<a href="simpanpasienxls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
	...
	?>
      <tr bgcolor="#CCCCCC"><td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $tampil['nopasien'];?>"/></td>
       <td><div align="center"><?php echo $no=$no+1;?></td>
          ...
          <td align="center"><a href="?page=detail_pasien&nopasien=<?php echo $tampil['nopasien'];?>"><?php echo $tampil['namapas']?></a></td>
		  <td align="center"><?php echo $tampil['almpas'];?></td>
          <td align="center"><?php echo $tampil['telppas'];?></td>
          <td width="6%"><div align="center"><a href="?page=edit_pasien&nopasien=<?php echo $tampil['nopasien'];?>">Edit</a></div></td>
          <td width="6%"><div align="center"><a href="?page=delete_pasien&nopasien=<?php echo $tampil['nopasien'];?>" onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')">Hapus</a></div></td>
          </tr>
        <?php
  }
}
