	...
	<table width="100%" cellspacing="0" cellpadding="3">
		<tr>
			<td height="50" colspan="4" style="color:#009b4c; font-size:24px;" align="center"><font face="ninja naruto"><?php echo "DETAIL DATA RINCIAN BIAYA";?></font></td>
				...
				<tr>
			<td width="212">ID RINCIAN BIAYA</td>
			<td width="5">:</td>
		...
		<tr>
			<td colspan="3"><a href="?page=edit_rincianbiaya&idrincianbiaya=<?php echo $tampilrincianbiaya['idrincianbiaya'];?>" title="sunting">[SUNTING]</a>&nbsp;&nbsp;<a href="javascript:history.back()" title="data rin">[KEMBALI]</a>&nbsp;&nbsp;</td>
		</tr>
	</table>
</div>
</body>
