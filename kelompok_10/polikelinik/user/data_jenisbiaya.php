...
<div>
  ...
  <tr>
    ...
    <td width="40%"><a href="?page=data_jenisbiaya" title="refresh">[Refresh]</a>&nbsp;&nbsp;<a href="simpanjenisbiayaxls.php">[Save to.excel]</a></td>
    <td width="9%">&nbsp;</td>
  </tr>
</table>
</form>
	...
	?>
      <tr bgcolor="#CCCCCC"><td height="27" align="center"><input type="checkbox" name="check_list[]" value="<?php echo $tampil['idjenisbiaya'];?>"/></td>
       <td><div align="center"><?php echo $no=$no+1;?></td>
          ...
          <td width="6%"><div align="center"><a href="?page=detail_jenisbiaya&idjenisbiaya=<?php echo $tampil['idjenisbiaya'];?>">Detail</a></div></td>
