...
else
{
	...
	$masukan=mysql_query("UPDATE pendaftaran SET nopendaftaran='$nopendaftaran',tglpendaftaran='$tglpendaftaran', nourut='$nourut',  NIP='$NIP', nopasien='$nopasien',  kodejadwal='$kodejadwal' WHERE nopendaftaran='$nopendaftaran'");
	if($masukan){
