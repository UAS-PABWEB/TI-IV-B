...
header("Content-Disposition: attachment; filename=Data-dokter.xls");//ganti nama sesuai keperluan
...
<div>
  <h2 align="center" style="color:#0000FF;">DATA DOKTER<br/>
  POLIKELINIK YADI</h2>
  <div style="padding-top:10px;"></div>
</div>
<form method="post" action="deleteall_dokter.php">
<?php
    ...
    <tr>
      <td><table width="100%" cellspacing="1" cellpadding="3" ><tr bgcolor="#009b4c" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" ><td width="9%"><table width="100%" cellspacing="1" cellpadding="3" >
        <tr bgcolor="#8fb041" style="font-weight:bold; font-size:13px;color:#FFFFFF" align="center" >
          ...
          <td width="10%" height="30" bgcolor="#009b4c">KODE DOKTER</td>
          <td width="10%" bgcolor="#009b4c">NAMA DOKTER</td>
          <td width="10%" bgcolor="#009b4c">ALAMAT DOKTER</td>
          <td width="10%" bgcolor="#009b4c">TELEPON DOKTER</td>
          <td width="10%" bgcolor="#009b4c">KODE POLIKELINIK</td>
          </tr>
        <?php
	if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
{
	$search = $_POST['search'];
	$sql1 = mysql_query("SELECT * FROM dokter LIKE '%$search%'") or die(mysql_error());
	}
	else{
  ...
  <tr><td align="center" bgcolor="#ffffff"><?php echo $no=$no+1;?></td>
    ...
    <td align="center" bgcolor="#ffffff"><a href=""><?php echo $tampil['nmdokter']?></a></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['almdokter'];?></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['tlpdokter'];?></td>
    <td align="center" bgcolor="#ffffff"><?php echo $tampil['kodepoll'];?></td>
     </tr>
  <?php
  }
}
