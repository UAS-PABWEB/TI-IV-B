...
else
{
	...
	$masukan=mysql_query("UPDATE dokter SET kodedokter='$kodedokter',nmdokter='$nmdokter', almdokter='$almdokter',  tlpdokter='$tlpdokter', kodepoll='$kodepoll' WHERE kodedokter='$kodedokter'");
	if($masukan){
