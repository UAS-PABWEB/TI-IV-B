...
<html>
  <head>
    ...
    <title>APLIKASI STOK BARANG MASUK KELUAR </title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>APLIKASI STOK BARANG MASUK KELUAR </span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>APLIKASI STOK BARANG MASUK KELUAR  </b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo" $_SESSION[namalengkap] "?> - ADMINISTRATOR
                  ...
                  <li class="user-footer">
					...
					<div class="pull-left">
                      <a href="?pg=admin&act=view" class="btn btn-default btn-flat">Setting</a>
                    </div>
                  </li>
                </ul>
              </li>
