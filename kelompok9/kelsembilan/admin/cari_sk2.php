    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input type="text" class="search form-control" name="search" id="searchid" onfocus="if(!this._haschanged){this.value=''};this._haschanged=true;" placeholder="Search for No Agenda SK" name="nrp" />  
                <div     id="result"></div>
            </div>
