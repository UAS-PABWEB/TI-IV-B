...
if(isset($_POST['btnUbah'])){
  ...
  $PERIHAL         			= $_POST['PERIHAL'];
         ...
         $Token = $_GET['Token'];
         $dat = $mysqli->query("UPDATE surat_keluar SET   
                NO_AGENDASK        			   = '$NO_AGENDASK',
                ID             				   = '$ID',
...
$Token = $_GET['Token'];
$cek = $mysqli->query("SELECT * FROM  surat_keluar WHERE NO_AGENDASK='$Token'");
        ...
        <div class="container">
            <div class="box first">
                ...
                <header class="panel-heading">
                              <h3 align="center">Sunting Data Surat Keluar </h3><br>
  ...
  <div class="row"> 
       <div class="item form-group" align="left">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">                                            
                  <input  class="form-control col-md-8 col-xs-12" style="color:#fdfdff;"   name="NO_AGENDASK" value="<?php echo $row['NO_AGENDASK']; ?>" required type="text">      
                </div>
            </div>
