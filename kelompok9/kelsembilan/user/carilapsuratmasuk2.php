<div  style="background-image: url(images/i.jpg);" data-stellar-background-ratio="0.10">
...
<br>
 ...
 <hr>
       ...
       <div style="color: #000000;" class="col-md-9 col-sm-9 col-xs-12" style="font-size:14px;">
    ...
    <a href= "doc4.php?token=<?php echo $row['NO_AGENDASM'] ?>" style="color:#000000;" >Export to doc</a>
