...
<tr>
	...
	LAPORAN SURAT KIRIM PER PERIODE </font></th>
	</tr>
	<tr>
		<td><hr /></td>
		</tr>
		...
		<tr>
			...
			<th width="9%" align="left" scope="col" bgcolor="#00CC99"><strong>NO AGENDA SURAT KELUAR</strong></th>
			...
			<th width="13%" align="left" scope="col" bgcolor="#00CC99"><strong>TANGGAL KIRIM</strong>
			</th>
...
$sql = "SELECT *FROM surat_keluar
			WHERE TANGGAL_KIRIM >= '$tglmulai' AND TANGGAL_KIRIM
			<= '$tglsampai'
			ORDER BY NO_AGENDASK asc";
...
Geneva, sans-serif" size="2"><?php echo $record['NO_AGENDASK'] ?> </font></td>
<td align="left" scope="col" bgcolor="#ffffff"><font face="Tahoma,
Geneva, sans-serif" size="2"><?php echo $record['ID'] ?> </font></td>
<td align="left" scope="col" bgcolor="#ffffff"><font face="Tahoma,
Geneva, sans-serif" size="2"><?php echo $record['JENIS_SURAT'] ?> </font></td>
<td align="left" scope="col" bgcolor="#ffffff"><font face="Tahoma,
Geneva, sans-serif" size="2"><?php echo $record['TANGGAL_KIRIM'] ?> </font></td>
