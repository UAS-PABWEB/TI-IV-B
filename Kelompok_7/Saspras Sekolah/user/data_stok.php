...
-->
    ...
    <section id="services">
        ...
        <div class="box first">
            ...
            <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <h3 align="center" class="style1"> Stok </h3>
                    <br>
         ...
         <br>
          <form class="form-horizontal form-label-left" novalidate action="?page=data_stok" method="POST" name="cari">
    <div class="row">
        <div class="col-md-12">
         ...
         <table class="table table-striped   table-hover">
          ...
          <tr>
            ...
            <th width="99" class="hidden-phone"><i class=></i> KODE BARANG </th>
              <th width="99"><i class=></i> NAMA BARANG</th>   
              <th width="99"><i class=></i> JUMLAH BARANG MASUK</th> 
              <th width="99"><i class=></i> JUMLAH BARANG KELUAR</th>  
              <th width="99"><i class=></i> TOTAL BARANG</th> 
        ...
        if ((isset($_POST['submit'])) AND ($_POST['search'] <> ""))
        {
         ...
         $sql1 = $mysqli->query("SELECT * FROM stok WHERE nama_brg LIKE '%$search%' or nama_brg LIKE '$search'");
             ...
             $sql1 = $mysqli->query("SELECT * FROM stok order by nama_brg asc LIMIT 5");
         }
