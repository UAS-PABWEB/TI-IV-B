...
function uncheck_all()
{
    ...
    <section id="services">
        <div class="container">
         ...
         <br>
          <form class="form-horizontal form-label-left" novalidate action="?page=stok/data_stok" method="POST" name="cari">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" align="left">
                              ...
                              <button class="btn btn-default" name="submit" type="submit "><i class="fa fa-search"></i> Cari</button> <a href="?page=stok/input_stok" class="btn btn-primary"> Tambah Data</a> <a href="stok/stokxls.php" class="btn btn-danger" >Simpan Excel</a>
            </div>
        </div>
    </div>   
</form>
        ...
        <form method="post" action="?page=stok/deleteallstok">
<section class="panel">       
    <table class="table table-striped   table-hover">
        ...
        <tr>
            ...
            <th><i class=></i> JUMLAH BARANG MASUK </th> 
            <th><i class=></i> JUMLAH BARANG KELUAR</th>  
            <th><i class=></i> TOTAL BARANG</th> 
        ...
        {
         $search = $_POST['search'];
         $sql1 = $mysqli->query("SELECT * FROM stok WHERE nama_brg LIKE '%$search%' or nama_brg LIKE '$search'");
         }
         else{
             $sql1 = $mysqli->query("SELECT * FROM stok order by nama_brg asc LIMIT 8");
         }
    ...
    ?>
	    ...
	    <td class="hidden-phone"><?php echo $tampil['nama_brg']; ?> </td>
            <td class="hidden-phone"><?php echo $tampil['jml_brg_masuk']; ?> </td>
            <td class="hidden-phone"><?php echo $tampil['jml_brg_keluar']; ?> </td>
            <td class="hidden-phone"><?php echo $tampil['total_brg']; ?> </td>
            <td class="hidden-phone"><?php echo $tampil['keterangan']; ?> </td>
           
            <td class="hidden-phone"> <a href="?page=stok/ubah_stok&Token=<?php echo $tampil['kode_barang']; ?>" class="btn btn-primary btn-xs">Edit</i></a></td>
            <td class="hidden-phone"> <a href="?page=stok/hapus_stok&Token=<?php echo $tampil['kode_barang']; ?>"  onClick="return confirm('Apakah anda yakin ingin menghapus data ini ?')" class="btn btn-danger btn-xs">Hapus</i></a></td>                       
