        ...
        <div class='widget-content nopadding'>
		  ...
		  <input type='hidden' name='id' value='$_data[kdJadwal]'>
              ...
              <div class='controls'>
                <div  data-date='12-02-2017' class='input-append date datepicker'>
                  <input type='text'  data-date-format='mm-dd-yyyy' value='$_data[tglJadwal]' class='span11' name='txtTglJadwal' >
          ...
          <div class='control-group'>
            ...
            <div class='control-group'>
              ...
              <div class='controls'>
                <input type='text' class='span2'  name='txtHarga' value='$_data[harga]' />
              </div>
            </div>
