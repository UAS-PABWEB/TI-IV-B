            ...
            <div class="span6">
              <table class="">
                <tbody>
                  <tr>
                    <td>
                      <h4>AK_FUTSAL Majalengka</h4>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Jl. Lemah Putih (Belakang Alfamart), Majalengka, Jawa Barat
                    </td>
                  </tr>

                  <tr>
                    <td>Phone: 087722176553</td>
                  </tr>
                  <tr>
                    <td>fadhliatulakbar10@gmail.com</td>
                  </tr>
                </tbody>
              </table>
            </div>
                  ...
                  <td class="width70">
                    ...
                    <div id="myModal" class="modal hide">
                      <div class="modal-header">
                        ...
                        <h3>DAFTAR JADWAL LAPANGAN AK_FUTSAL MAJALENGKA</h3>
                      </div>
                      <div class="modal-body">
                        <div class="widget-box">
                          ...
                          <table class="table table-bordered data-table">
                            ...
                            <tbody>
                              <?php
                              $SQL = mysql_query("SELECT * FROM tjadwal,tjam WHERE tjadwal.kdJam=tjam.kdJam AND tjadwal.statusBoking='R' ORDER BY tjadwal.tglJadwal ASC");
                              $no = 1;
		...
		<a href='$loadModule?load=boking&action=hapusData&id=$_data[kdBokingTemp]'><button class='btn btn-danger'><i class='icon-trash'></i> &nbsp; Delete</button></a>
              ...
              <table class="table table-bordered table-invoice-full">
                <tbody>
                  <tr>
                    <td class="msg-invoice" width="85%">
                      <h4>Invoice Boking Lapangan AK_Futsal </h4>
                      <a href="#" class="tip-bottom" title="Kasir">Kasir</a> | <a href="#" class="tip-bottom" title="BCA (78889991) - Mandiri (788928292)-BRI (082928938) ">BCA (78889991) - Mandiri (788928292)-BRI (082928938) </a> | <a href="#" class="tip-bottom" title="SWIFT code">Design By : </a>| <a href="https://www.instagram.com/adh_akbarr/" class="tip-bottom" title="address">Adh_Akbar </a>
                    </td>
                ...
                <div class='pull-right'>
                  ...
                  <br>";
                    ?>
                    <a class="btn btn-primary btn-large pull-right" href="?load=boking&action=informasi">Lanjutkan Transaksi</a>
            </div>
          </div>
        </div>
      </div>
