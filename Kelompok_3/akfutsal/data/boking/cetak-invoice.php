...
<div class='container-fluid'>
              ...
              <div class='span6'>
                <table class='table table-bordered table-invoice'>
                  <tbody>
					...
					<tr>
					<td colspan='2'>
					<a href='javascript:;' onClick='window.print()'><button class='btn btn-success btn-large'><i class='icon-print'></i>Print</button></a>
					</td>
                    <tr>
  ...
  echo "
                ...
                <table class='table table-bordered table-invoice-full'>
                  <tbody>
                    <tr>
                      <td class='msg-invoice' width='85%'><h4>Invoice Boking Lapangan AK_Futsal </h4>
