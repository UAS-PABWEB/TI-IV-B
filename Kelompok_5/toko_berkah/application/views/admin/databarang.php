        ...
        <tbody>
            ...
            foreach ($barang as $brg) : ?>
                ...
                <tr>
                    ...
                    <td><?= anchor('admin/Data_barang/detail/' . $brg['id_brg'], '<button class="btn btn-success btn-sm"><i class="fas fa-search"></i></button>') ?></td>
                    <td><?= anchor('admin/Data_barang/edit/' . $brg['id_brg'], '<button class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i></button>') ?></td>
                    <td><?= anchor('admin/Data_barang/delete/' . $brg['id_brg'], '<button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>') ?></td>
                </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('admin/Data_barang/tambahBarang') ?>" enctype="multipart/form-data">
