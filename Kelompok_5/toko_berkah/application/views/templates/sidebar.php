...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
      ...
      <div class="sidebar-brand-text mx-3">TOKO BERKAH</div>
    </a>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php if ($this->session->userdata('role_id') == 2) : ?>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?=base_url('assets/img/noprofile.png')?>">
              </a>
          ...
          <?php elseif ($this->session->userdata('role_id') == 1) : ?>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <!-- Dropdown - User Information -->
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?php base_url('admin/DashboardAdmin') ?>" >
                  <i class="fas fa-chart-line fa-sm fa-fw mr-2 text-gray-400"></i>
                  Dashboard
                </a>
                <a class="dropdown-item" href="<?php base_url('Auth/logout') ?>">
                  <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                  Logout
                </a>
              </div>
