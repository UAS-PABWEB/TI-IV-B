...
<!doctype html>
    <html lang="en">
        <head>
            ...
            <meta name="author" content="Krisman Nurslamet">
    ...
    <body><br>
        <div class="container-fluid">
            <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
                <h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas fa-home title-icon"></i>Data Stok Barang Kafe</h5>
            </div>
        </div>
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                        &copy; 2020 - <a class="text-info" href="#">Gudang Kafe</a>
                    </div>
                </div>
            </footer>
        </div>
